...
function Footer({ profile }: { profile?: ISiteProfile }) {
  ...
  return (
    ...
    >
          ...
          <div className="grid my-4 md:grid-cols-5 sm:grid-cols-2 grid-cols-1 sm:gap-8">
            ...
            <div className={`bg-background flex flex-col mt-8`}>
              ...
              <div className="space-y-1 mt-2 text-sm">
                <Link href="/kebijakan" className="flex items-center space-x-2">
            ...
            <div className={`bg-background flex flex-col mt-8`}>
              ...
              <div className="flex flex-wrap mt-2">
                {data?.map((item, idx) => (
                  <Link
                    key={`${idx}`}
                    className={`bg-[${theme.primary}] mr-2 mb-2 rounded-full text-[${theme.primary}]`}
                    href={item.value}
                  >
                    <div className="p-0.5">
      ...
      <div className={`bg-[${theme.primary}] w-full p-3`}>
