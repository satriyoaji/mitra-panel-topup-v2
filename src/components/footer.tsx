      ...
      <div className="w-full flex items-center flex-col mb-8">
        <div className="max-w-6xl px-6">
          <p className="font-semibold text-sm">
            Top Up Game Online dan Beli Voucher Game Online Terbaru dan Murah di
            Topmur
          </p>
          <p className="text-muted-foreground text-xs mt-1.5 leading-5">
            Top Up game & voucher Topmur.com. Metode pembayaran lengkap, dijamin
            aman, garansi uang kembali 10x lipat, instant proses, terpercaya dan
            legal 100%. Buat para buyer, seller, dan sultan-sultan di luar sana
            pastikan belanja dan jualan top up game dan voucher mu di
            Topmur.com. Tersedia bermacam-macam jenis game populer seperti
            Mobile Legends, PUBG Mob... Valorant, Free Fire, Ragnarok, Dragon
            Raja, Light Of Thel, Steam Wallet dan berbagai game lainnya yang
            tidak kalah seru untuk dimainkan.
          </p>
          <div className="grid my-4 md:grid-cols-5 sm:grid-cols-2 grid-cols-1 sm:gap-8">
            <div className="md:col-span-2 mt-8">
              ...
              <p className="text-muted-foreground text-xs mt-1.5 leading-5">
                Topumur adalah menyediakan layanan Top up game dan Reseller
                Voucher Game termurah dan terpercaya di Indonesia. Topup lebih
                dari 100 game online terkemuka dunia di VocaGame mudah aman
                tanpa registrasi, pembelian instan langsung masuk dalam hitungan
                detik.
              </p>
            </div>
            <div className={`bg-background flex flex-col mt-8`}>
              <p className="font-bold text-foreground text-sm">Menu Lainnya</p>
            ...
            <div className={`bg-background flex flex-col mt-8`}>
              <p className="font-bold text-foreground text-sm">Ikuti kami di</p>
